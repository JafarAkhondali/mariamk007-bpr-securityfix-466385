...
<body id="page-top">
    ...
    <body class="header-content">
        <div class="header-content-inner">
            <h3 class="text-center" style="color:green;">Pembayaran Dompet Digital</h3><br>
            <hr class="hrcenter">
            <p class="text-center">*Pembayaran dengan Dompet Digital Dapat Melalui ATM atau Mobile Banking atau Internet
                Banking</p>
                ...
                <div class="id-card">
                    <div class="profile-row">
                        ...
                        <div class="desc">
                            ...
                            <p>Saat Ini Kami Tidak Melayani Pembayaran Dompet Digital</p>
                        </div>
                    </div>
