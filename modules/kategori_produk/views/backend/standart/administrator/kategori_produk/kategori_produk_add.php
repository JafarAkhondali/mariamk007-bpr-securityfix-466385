...
<section class="content-header">
    <h1>
        Kategori Produk        <small><?= cclang('new', ['Kategori Produk']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/kategori_produk'); ?>">Kategori Produk</a></li>
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kategori Produk']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
    ...
    <div class="form-group group-photo ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="kategori_produk_photo_uuid" id="kategori_produk_photo_uuid" type="hidden" value="<?= set_value('kategori_produk_photo_uuid'); ?>">
                                <input class="data_file" name="kategori_produk_photo_name" id="kategori_produk_photo_name" type="hidden" value="<?= set_value('kategori_produk_photo_name'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/kategori_produk/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id_photo = $('#kategori_produk_photo_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_photo !== 'undefined') {
                $('#kategori_produk_photo_galery').fineUploader('deleteFile', id_photo);
            }
