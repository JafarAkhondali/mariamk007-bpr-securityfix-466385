                        ...
                        <div class="form-group group-username">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control chosen chosen-select-deselect" name="username" id="username" data-placeholder="Select Username">
                                        ...
                                        <option <?= $row->username == $survei_lapangan->username ? 'selected' : ''; ?> value="<?= $row->username ?>"><?= $row->username; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <small class="info help-block">
                                        </small>
                        ...
                        <div class="form-group group-status_layak  ">
                                ...
                                <div class="col-sm-6">
                                    <div class="col-md-2 padding-left-0">
                                        <label>
                                            <input type="radio" class="flat-red" name="status_layak" id="status_layak" value="yes" <?= $survei_lapangan->status_layak == "yes" ? "checked" : ""; ?>>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="col-md-14">
                                        <label>
                                            <input type="radio" class="flat-red" name="status_layak" id="status_layak" value="no" <?= $survei_lapangan->status_layak == "no" ? "checked" : ""; ?>>
                                            No
                                        </label>
                                    </div>
                                    <small class="info help-block">
