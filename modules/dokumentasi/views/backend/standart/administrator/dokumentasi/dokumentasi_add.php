...
<section class="content-header">
    <h1>
        Dokumentasi        <small><?= cclang('new', ['Dokumentasi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/dokumentasi'); ?>">Dokumentasi</a></li>
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group group-nama_kegiatan ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_kegiatan" id="nama_kegiatan" placeholder="Nama Kegiatan" value="<?= set_value('nama_kegiatan'); ?>">
    ...
    <div class="form-group group-photo ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="dokumentasi_photo_uuid" id="dokumentasi_photo_uuid" type="hidden" value="<?= set_value('dokumentasi_photo_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_photo_name" id="dokumentasi_photo_name" type="hidden" value="<?= set_value('dokumentasi_photo_name'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/dokumentasi/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id_photo = $('#dokumentasi_photo_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_photo !== 'undefined') {
                $('#dokumentasi_photo_galery').fineUploader('deleteFile', id_photo);
            }
