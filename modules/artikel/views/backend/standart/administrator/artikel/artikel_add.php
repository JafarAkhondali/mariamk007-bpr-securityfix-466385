...
<section class="content-header">
    <h1>
        Artikel        <small><?= cclang('new', ['Artikel']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/artikel'); ?>">Artikel</a></li>
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Artikel']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_artikel',
    ...
    <div class="form-group group-deskripsi_artikel ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="deskripsi_artikel" id="deskripsi_artikel" placeholder="Deskripsi Artikel" value="<?= set_value('deskripsi_artikel'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-isi_artikel ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="isi_artikel" name="isi_artikel" rows="5" cols="80"><?= set_value('Isi Artikel'); ?></textarea>
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
    ...
    <div class="form-group group-photo ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="artikel_photo_uuid" id="artikel_photo_uuid" type="hidden" value="<?= set_value('artikel_photo_uuid'); ?>">
                                <input class="data_file" name="artikel_photo_name" id="artikel_photo_name" type="hidden" value="<?= set_value('artikel_photo_name'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/artikel/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id_photo = $('#artikel_photo_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_photo !== 'undefined') {
                $('#artikel_photo_galery').fineUploader('deleteFile', id_photo);
            }
