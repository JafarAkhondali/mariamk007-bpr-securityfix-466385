                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            <div class="row pull-right">
                                ...
                                <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new"
                                    title="<?= cclang('add_new_button', [cclang('simulasi_kredit')]); ?>  (Ctrl+a)"
                                    href="<?= site_url('administrator/simulasi_kredit/add'); ?>"><i
                                        class="fa fa-plus-square-o"></i>
                                    <?= cclang('add_new_button', [cclang('simulasi_kredit')]); ?></a>
                                <a class="btn btn-flat btn-success" title="Import Data Simulasi Kredit" href="#"
                                    data-toggle="modal" data-target="#import"><i class="fa fa-plus-square-o"></i> Import
                                    Data</a>
                                <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST"
                                                action="<?= base_url('administrator/simulasi_kredit/import') ?>"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    <div class="col-md-12">
                                                                        <label
                                                                            class="col-form-label text-md-left">Upload
                                                                            File</label>
                                                                        <input type="file" class="form-control"
                                                                            name="file" accept=".xls, .xlsx" required>
                                                                        <div class="mt-1">
                                                                            <span class="text-secondary">File yang harus
                                                                                diupload : .xls, xlsx</span>
                                                                        </div>
                        ...
                        <?php }) ?> -->
                            ...
                            <h5 class="widget-user-desc"><?= cclang('list_all', [cclang('simulasi_kredit')]); ?> <i
                                    class="label bg-yellow"><?= $simulasi_kredit_counts; ?> <?= cclang('items'); ?></i>
                            </h5>
                        </div>

                        <form name="form_simulasi_kredit" id="form_simulasi_kredit"
                            action="<?= base_url('administrator/simulasi_kredit/index'); ?>">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="col-sm-3 padd-left-0 ">
                                        <select type="text" class="form-control chosen chosen-select" name="f"
                                            ...
                                            <option <?= $this->input->get('f') == 'plafond' ? 'selected' : ''; ?>
                                                value="plafond">Plafond</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_12' ? 'selected' : ''; ?>
                                                value="jangkawaktu_12">Jangkawaktu 12</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_18' ? 'selected' : ''; ?>
                                                value="jangkawaktu_18">Jangkawaktu 18</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_24' ? 'selected' : ''; ?>
                                                value="jangkawaktu_24">Jangkawaktu 24</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_30' ? 'selected' : ''; ?>
                                                value="jangkawaktu_30">Jangkawaktu 30</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_36' ? 'selected' : ''; ?>
                                                value="jangkawaktu_36">Jangkawaktu 36</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_48' ? 'selected' : ''; ?>
                                                value="jangkawaktu_48">Jangkawaktu 48</option>
                                            <option <?= $this->input->get('f') == 'jangkawaktu_60' ? 'selected' : ''; ?>
                                                value="jangkawaktu_60">Jangkawaktu 60</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-1 padd-left-0 ">
                                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply"
                                            href="<?= base_url('administrator/simulasi_kredit'); ?>"
                                ...
                                <table class="table table-bordered table-striped dataTable">
                                    <thead>
                                        <tr class="">
                                            ...
                                            <th data-field="plafond" data-sort="1" data-primary-key="0">
                                                <?= cclang('plafond') ?></th>
                                            <th data-field="jangkawaktu_12" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_12') ?></th>
                                            <th data-field="jangkawaktu_18" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_18') ?></th>
                                            <th data-field="jangkawaktu_24" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_24') ?></th>
                                            <th data-field="jangkawaktu_30" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_30') ?></th>
                                            <th data-field="jangkawaktu_36" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_36') ?></th>
                                            <th data-field="jangkawaktu_48" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_48') ?></th>
                                            <th data-field="jangkawaktu_60" data-sort="1" data-primary-key="0">
                                                <?= cclang('jangkawaktu_60') ?></th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbody_simulasi_kredit">
                                        ...
                                        <tr>
                                            ...
                                            <td width="200">
                                                ...
                                                <a href="<?= site_url('administrator/simulasi_kredit/view/' . $simulasi_kredit->id); ?>"
                                                    class="label-default"><i class="fa fa-newspaper-o"></i>
                                                    <?= cclang('view_button'); ?>
                                                    <?php }) ?>
                                                    <?php is_allowed('simulasi_kredit_update', function () use ($simulasi_kredit) { ?>
                                                    <a href="<?= site_url('administrator/simulasi_kredit/edit/' . $simulasi_kredit->id); ?>"
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        data-href="<?= site_url('administrator/simulasi_kredit/delete/' . $simulasi_kredit->id); ?>"
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        document.location.href = BASE_URL +
                            '/administrator/simulasi_kredit/delete?' + serialize_bulk;
                    }
                });
