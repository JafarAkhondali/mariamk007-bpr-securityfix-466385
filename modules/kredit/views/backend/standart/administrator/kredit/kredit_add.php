...
<section class="content-header">
    <h1>
        Kredit        <small><?= cclang('new', ['Kredit']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/kredit'); ?>">Kredit</a></li>
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kredit']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_kredit',
                        ...
                        <div class="form-group group-nama_kredit ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_kredit" id="nama_kredit" placeholder="Nama Kredit" value="<?= set_value('nama_kredit'); ?>">
    ...
    <div class="form-group group-photo ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="kredit_photo_uuid" id="kredit_photo_uuid" type="hidden" value="<?= set_value('kredit_photo_uuid'); ?>">
                                <input class="data_file" name="kredit_photo_name" id="kredit_photo_name" type="hidden" value="<?= set_value('kredit_photo_name'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
    ...
    <div class="form-group group-deskripsi_kredit ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="deskripsi_kredit" name="deskripsi_kredit" rows="5" cols="80"><?= set_value('Deskripsi Kredit'); ?></textarea>
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/kredit/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id_photo = $('#kredit_photo_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_photo !== 'undefined') {
                $('#kredit_photo_galery').fineUploader('deleteFile', id_photo);
            }
            $('.chosen option').prop('selected', false).trigger('chosen:updated');
            deskripsi_kredit.setData('');
