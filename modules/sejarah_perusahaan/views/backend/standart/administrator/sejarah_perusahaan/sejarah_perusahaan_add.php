...
<section class="content-header">
    <h1>
        Sejarah Perusahaan        <small><?= cclang('new', ['Sejarah Perusahaan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/sejarah_perusahaan'); ?>">Sejarah Perusahaan</a></li>
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Sejarah Perusahaan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
    ...
    <div class="form-group group-judul_sejarah ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="judul_sejarah" id="judul_sejarah" placeholder="Judul Sejarah" value="<?= set_value('judul_sejarah'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-deskripsi_sejarah ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="deskripsi_sejarah" name="deskripsi_sejarah" rows="5" cols="80"><?= set_value('Deskripsi Sejarah'); ?></textarea>
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/sejarah_perusahaan/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
