...
<section class="content-header">
    <h1>
        Job Deskripsi Pekerjaan        <small><?= cclang('new', ['Job Deskripsi Pekerjaan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/job_deskripsi_pekerjaan'); ?>">Job Deskripsi Pekerjaan</a></li>
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Job Deskripsi Pekerjaan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group group-nama_department ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_department" id="nama_department" placeholder="Nama Department" value="<?= set_value('nama_department'); ?>">
    ...
    <div class="form-group group-deskripsi_pekerjaan ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="deskripsi_pekerjaan" name="deskripsi_pekerjaan" rows="5" cols="80"><?= set_value('Deskripsi Pekerjaan'); ?></textarea>
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/job_deskripsi_pekerjaan/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
