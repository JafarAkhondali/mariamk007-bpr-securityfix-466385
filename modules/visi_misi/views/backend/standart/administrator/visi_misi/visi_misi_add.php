...
<section class="content-header">
    <h1>
        Visi Misi <small><?= cclang('new', ['Visi Misi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
        <li class=""><a href="<?= admin_site_url('/visi_misi'); ?>">Visi Misi</a></li>
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Visi Misi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_visi_misi',
                        ...
                        <div class="form-group group-icon ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group icon col-sm-8">
                                    <input type="text" class="form-control pull-right" name="icon" placeholder="Icon"
                                        id="icon">
                                </div>
                        ...
                        <div class="form-group group-deskripsi ">
                            <label for="deskripsi" class="col-sm-2 control-label">Deskripsi <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <textarea id="deskripsi" name="deskripsi" rows="5"
                                    cols="80"><?= set_value('Deskripsi'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('.btn_save').click(function() {
        ...
        $.ajax({
                url: BASE_URL + '/administrator/visi_misi/add_save',
                type: 'POST',
                dataType: 'json',
                data: data_post,
            })
