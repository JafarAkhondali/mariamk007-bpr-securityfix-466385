                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Faq</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/faq/edit_save/'.$this->uri->segment(4)), [
                            'name' => 'form_faq',
                        ...
                        <div class="form-group group-pertanyaan  ">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="pertanyaan" name="pertanyaan" rows="10" cols="80"> <?= set_value('pertanyaan', $faq->pertanyaan); ?></textarea>
                        ...
                        <div class="form-group group-jawaban  ">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="jawaban" name="jawaban" rows="10" cols="80"> <?= set_value('jawaban', $faq->jawaban); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
...
<script>
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#faq_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {
