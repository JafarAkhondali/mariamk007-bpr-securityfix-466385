                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_sku)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_sku; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_sku; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_sku pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_skp)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_skp; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_skp; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_skp pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_photo)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_photo; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_photo; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_photo pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_ktp_istri)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_ktp_istri; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_ktp_istri; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_ktp_istri pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_kk)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_kk; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_kk; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_kk pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_surat_nikah)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_surat_nikah; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_surat_nikah; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_surat_nikah pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_jaminan)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_jaminan; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_jaminan; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_jaminan pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_rekening_listrik)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_rekening_listrik; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_rekening_listrik; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_rekening_listrik pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($pengajuan_kredit->file_pbb_stnk)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_pbb_stnk; ?>">
                                <img src="<?= BASE_URL . 'uploads/pengajuan_kredit/' . $pengajuan_kredit->file_pbb_stnk; ?>" class="image-responsive" alt="image pengajuan_kredit" title="file_pbb_stnk pengajuan_kredit" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
