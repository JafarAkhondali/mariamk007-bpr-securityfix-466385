                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-nama  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="" value="<?= set_value('nama', $pegawai->nama); ?>">
                        ...
                        <div class="form-group group-jabatan  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="" value="<?= set_value('jabatan', $pegawai->jabatan); ?>">
                                    <small class="info help-block">
